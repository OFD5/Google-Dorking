...
#
Google Dorking, a technique for uncovering online vulnerabilities, plays a pivotal role. You must use different search engines During OSINT to try to find Vulnerabiities such as yahoo, bing, duckduckgo, wayback machine, Pastebin, etc. 
#
# Google dork Commands cheatsheet
